...
<div id="smb_my">
    ...
    <section id="smb_my_ov">
		...
		<p id="sod_v_info">업체관리는 PC를 이용하여 주세요.</p>
		<div class="my_name">
			<strong>업체관리</strong>
            <ul class="smb_my_act">
				<li><a href="<?php echo G5_SHOP_URL; ?>/itemform.php" class="btn_admin" target="new">업체등록</a></li>
				<li><a href="<?php echo G5_SHOP_URL; ?>/itemlist.php" class="btn_admin"  target="new">업체리스트</a></li>
				<li><a href="<?php echo G5_SHOP_URL; ?>/orderlist.php" class="btn_admin"  target="new">주문관리</a></li>
    ...
    <section id="smb_my_od">
        <h2><a href="<?php echo G5_SHOP_URL; ?>/orderinquiry.php">고객 주문내역</a></h2>
