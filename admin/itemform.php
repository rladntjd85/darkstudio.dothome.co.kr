...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="it_name">메뉴명</label></th>
            <td colspan="2">
		...
		<tr>
            <th scope="row"><label for="it_nocoupon">추천업체 유형</label></th>
            <td>
                <input type="checkbox" name="it_nocoupon" value="1" id="it_nocoupon" <?php echo ($it['it_nocoupon']) ? "checked" : ""; ?>> 추천업체
            </td>
        </tr>
		<tr>
		...
		<!-- <tr>
			  ...
			  <td>
				...
				<input type="checkbox" name="it_8" value="인기메뉴" <?php echo ($it['it_8'] ? "checked" : ""); ?> id="it_8">인기메뉴
        ...
        <tr>
            <th scope="row">메뉴 내용 </th>
			<?if ($w == ""){?>
			<td>
			<input type="button" class="btnAdd btn_frmline" value="메뉴추가" style=" cursor:pointer" name="addStaff">
				...
				<div style="margin-top:20px;border:1px solid #ccc" name="trStaff">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<th width="100">메뉴명</th>
							<td  width="500">
								<input type="text" name="p_title[]" value="" id="p_title" class="frm_input frm_input_full" placeholder="메뉴명">
						...
						<tr>
							<th>메뉴 설명</th>
							<td>
								<input type="text" name="p_basic[]" value="" id="p_basic" class="frm_input frm_input_full" placeholder="메뉴 설명">
							</td>
							<th>할인된 가격</th>
							<td>
				...
				<div style="margin-top:20px;border:1px solid #ccc" name="trStaff">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<th width="100">메뉴명</th>
							<td  width="500">
								<input type="text" name="p_title[]" value="<?=$row[p_title]?>" id="p_title" class="frm_input frm_input_full" placeholder="메뉴명">
						...
						<tr>
							<th>메뉴 설명</th>
							<td>
								<input type="text" name="p_basic[]" value="<?=$row[p_basic]?>" id="p_basic" class="frm_input frm_input_full" placeholder="메뉴 설명">
							</td>
							<th>할인된 가격</th>
							<td>
		...
		<script>
			...
			var addStaffText = '<div style="margin-top:20px;border:1px solid #ccc" name="trStaff"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><th width="100">메뉴명</th><td  width="500"><input type="text" name="p_title[]" value="" id="p_title" class="frm_input frm_input_full" placeholder="메뉴명" required><input type="hidden" name="p_idx[]" value=""></td><th  width="100">가격</th><td  width=""><input type="text" name="p_cust_price[]" value="" id="p_cust_price" class="frm_input " size="20" placeholder="할인전 가격"> 원</td></tr><tr><th>메뉴 설명</th><td><input type="text" name="p_basic[]" value="" id="p_basic" class="frm_input frm_input_full" placeholder="메뉴 설명"></td><th>할인된 가격</th><td><input type="text" name="p_price[]" value="" id="p_price" class="frm_input" size="20" placeholder="할인된 가격" required> 원</td></tr></table> <div style="cursor:pointer;text-align:center;width:100%;height:25px;line-height:25px;background:#9eacc6;color:#fff" onclick="remove_test(this)">삭제</div></div>'
