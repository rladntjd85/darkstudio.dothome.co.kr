...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
		...
		<th scope="col"  id="th_qty">추천업체</th>
        <th scope="col"  id="th_qty">업체사용</th>
    ...
    <tr class="<?php echo $bg; ?>">
		...
		<td>
            <label for="use_<?php echo $i; ?>" class="sound_only">추천업체</label>
            <input type="checkbox" name="it_nocoupon[<?php echo $i; ?>]" <?php echo ($row['it_nocoupon'] ? 'checked' : ''); ?> value="1" id="it_nocoupon<?php echo $i; ?>">

		</td>
		<td>
            <label for="use_<?php echo $i; ?>" class="sound_only">업체사용</label>
