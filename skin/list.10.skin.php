...
for ($i=0; $row=sql_fetch_array($result); $i++) {
	...
	?>
        <p style="font-size:16px;margin:10px 0;"><?=stripslashes($row['it_name'])?></p>
    <?
	}
	?>
	<div style="color:#ccc"><?=$row[it_basic]?></div>
	<div style="color:#ccc"><?=$row[it_10]?></div>
	<div style="color:#ccc"><?=round($row[distance],1);?>km</div>
